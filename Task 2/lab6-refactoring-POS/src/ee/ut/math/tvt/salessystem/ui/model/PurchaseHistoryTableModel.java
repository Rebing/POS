...
public class PurchaseHistoryTableModel extends SalesSystemTableModel<Sale> {
	...
	private List<Sale> tableRows;
	
	public PurchaseHistoryTableModel(SalesSystemModel salesSystemModel) {
		super(new String[] { "Id", "Time", "Sum", "Client" });
		this.model = salesSystemModel;
		tableRows = new ArrayList<Sale>();
	}
	...
	public void refresh() {
		...
		populateWithData(model.getDomainController().getAllSales());
