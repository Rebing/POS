...
public class PurchaseInfoTableModel extends SalesSystemTableModel<SoldItem> {
    ...
    */
    ...
    public void addItemToSale(final SoldItem soldItem) throws SalesSystemException {
        ...
        if (existingItem != null) {
            ...
            validateQuantityInStock(soldItem.getStockItem(), soldItem.getQuantity());
            getCurrentSale().addSoldItem(soldItem);
            log.debug("Added " + soldItem.getName()
                    + " quantity of " + soldItem.getQuantity());
        }
    ...
    public List<SoldItem> getTableRows(){
    	if(getCurrentSale() == null ) return new ArrayList<SoldItem>(); 

    	return new ArrayList<SoldItem>(getCurrentSale().getSoldItems());
    }
