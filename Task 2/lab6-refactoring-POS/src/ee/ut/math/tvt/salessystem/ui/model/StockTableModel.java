...
public class StockTableModel extends SalesSystemTableModel<StockItem> {
	...
	private List<StockItem> tableRows;
	
	public StockTableModel(SalesSystemModel salesSystemModel) {
		super(new String[] {"Id", "Name", "Price", "Quantity"});
		this.model = salesSystemModel;
		tableRows = new ArrayList<StockItem>();
	}
	...
	public void refresh() {
		populateWithData(model.getDomainController().getAllStockItems());
		fireTableDataChanged();
