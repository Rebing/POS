...
public class SalesSystemUI extends JFrame {
  ...
  private String stockTitle = "Warehouse";
  private String historyTitle = "History";
  private String clientTitle = "Clients";
  private String purchaseTitle = "Point-of-sale";
  ...
  private void drawWidgets() {
    ...
    tabbedPane.addChangeListener(new TabSelect(this));

    tabbedPane.add(purchaseTitle, purchaseTab.draw());
    tabbedPane.add(stockTitle, stockTab.draw());
    tabbedPane.add(historyTitle, historyTab.draw());
    tabbedPane.add(clientTitle, clientTab.draw());
